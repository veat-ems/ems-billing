...
$(function() {
	...
	$('#hidemenulayang').on('click', function(e) {       
         $('#divsrcall').hide();             
         $('#divsrcplus').hide();                 
	...
	$('#divsrcplus').hide(); 
    $('#hidesrcplus').on('click', function(e) {      
         $('#divsrcall').hide();
		 $('#hidemenu').hide();       
         $('#divsrcplus').toggle('show');  
    });
	
	$('#divsrcall').hide(); 
    $('#srcall').on('click', function(e) {       
         $('#divsrcplus').hide(); 
		 $('#hidemenu').hide();      
         $('#divsrcall').toggle('show'); 
    });
			...
			$("#foto_kwh_meter").change(function(){
   				readURL(this);
				});		

			$("#foto_form_dg").change(function(){
   				readURL2(this);
				});		

			$("#foto_pendamping").change(function(){
   				readURL3(this);
				});		

			$("#foto_mcb").change(function(){
   				readURL(this);
				});
