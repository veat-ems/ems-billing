$(function() {
	...
	var settingsHandler = function() {
		...
		$('#skin_color').attr("href", "assets/general/css/themes/" + appSetting.theme + ".css");
		...
		$('input[name="setting-theme"]').change(function() {
			...
			$('#skin_color').attr("href", "assets/general/css/themes/" + selectedTheme + ".css");
		...
		function switchLogo(theme) {
			switch (theme) {
				...
				case "theme-5":
				case "theme-6":
					$(".navbar-brand img").attr("src", "assets/general/images/logopm_merah_3d.png");
					break;

				default:
					$(".navbar-brand img").attr("src", "assets/general/images/logopm_putih_3d.png");
					break;
			}
		}
		...
		function defaultSetting() {
			...
			$('#skin_color').attr("href", "assets/general/css/themes/iaspp.css");
			$(".navbar-brand img").attr("src", "assets/general/images/logopm_putih_3d.png");
