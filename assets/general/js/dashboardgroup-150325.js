...
$(function () {
  ...
  function fetchdata() {
    ...
    $.ajax({
      url: "../../dashboardgroup/datameter/" + var_pageno,
      type: "post",
      success: function (data) {
        ...
        for (var i = 0; i < dataku.length; i++) {
          ...
          var id_variable0 = "group_id_val_variable0_" + c; // tkh
          var id_variable1 = "group_id_val_variable1_" + c;
          var id_variable2 = "group_id_val_variable2_" + c;
          var id_variable3 = "group_id_val_variable3_" + c;
          var id_variable4 = "group_id_val_variable4_" + c;
          var id_dt0 = "group_id_val_dt0_" + c;
          ...
          var id_satuan0 = "group_id_val_satuan0_" + c; // tkh
          var id_satuan1 = "group_id_val_satuan1_" + c;
          var id_satuan2 = "group_id_val_satuan2_" + c;
          var id_satuan3 = "group_id_val_satuan3_" + c;
          var id_satuan4 = "group_id_val_satuan4_" + c;
          ...
          let as = false; // ignored
          if (as){
              if (val_variable0 > 99999999) {
                val_variable0 = val_variable0 / 1000;
                val_satuan0 = "MWh";
              }
              if (val_variable1 > 99999999) {
                val_variable1 = val_variable1 / 1000;
                val_satuan1 = "MW";
              }
              if (val_variable2 > 99999999) {
                val_variable2 = val_variable2 / 1000;
                val_satuan2 = "MW";
              }
              if (val_variable3 > 99999999) {
                val_variable3 = val_variable3 / 1000;
                val_satuan3 = "MVA";
              }
              if (val_variable4 > 99999999) {
                val_variable4 = val_variable4 / 1000;
                val_satuan4 = "MVAR";
              }

              // format 1 decimal
              if (val_variable0 > 0) { // errror kalau >=0 
                val_variable0 = val_variable0.toFixed(1);
              }
              ...
              // star if null / ''
              if (val_variable0 == "" || val_variable0 == null) {
                val_variable0 = "*";
              }
              if (val_variable1 == "" || val_variable1 == null) {
                val_variable1 = "*";
              }
              if (val_variable2 == "" || val_variable2 == null) {
                val_variable2 = "*";
              }
              if (val_variable3 == "" || val_variable3 == null) {
                val_variable3 = "*";
              }
              if (val_variable4 == "" || val_variable4 == null) {
                val_variable4 = "*";
              }
              if (val_dt0 == "" || val_dt0 == null) {
                val_dt0 = "*";
              }
