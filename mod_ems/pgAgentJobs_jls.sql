...
INSERT INTO pgagent.pga_job(
    ...
    1::integer, 'JLS_EVERY_1_DAY'::text, ''::text, ''::text, true
...
INSERT INTO pgagent.pga_jobstep (
    ...
    ''::text, 'dbemspg_jls'::name, 'f'::character(1),
...
INSERT INTO pgagent.pga_job(
    ...
    1::integer, 'JLS_EVERY_1_HOUR'::text, ''::text, ''::text, true
) RETURNING jobid INTO jid;
...
INSERT INTO pgagent.pga_job(
    ...
    1::integer, 'JLS_EVERY_1_MONTH'::text, ''::text, ''::text, true
) RETURNING jobid INTO jid;
...
INSERT INTO pgagent.pga_job(
    ...
    1::integer, 'JLS_EVERY_5_MIN'::text, ''::text, ''::text, true
) RETURNING jobid INTO jid;
