ITB_SOHO_EVERY_1_DAY
ITB_SOHO_EVERY_1_HOUR
ITB_SOHO_EVERY_1_MONTH
ITB_SOHO_EVERY_5_MIN
...
INSERT INTO pgagent.pga_job(
    ...
    1::integer, 'ITB_SOHO_EVERY_1_DAY'::text, ''::text, ''::text, true
...
INSERT INTO pgagent.pga_jobstep (
    ...
    ''::text, 'dbemspg_itb'::name, 'f'::character(1),
...
INSERT INTO pgagent.pga_job(
    ...
    1::integer, 'ITB_SOHO_EVERY_1_HOUR'::text, ''::text, ''::text, true
) RETURNING jobid INTO jid;
...
INSERT INTO pgagent.pga_job(
    ...
    1::integer, 'ITB_SOHO_EVERY_1_MONTH'::text, ''::text, ''::text, true
) RETURNING jobid INTO jid;
...
INSERT INTO pgagent.pga_jobstep (
    ...
    ''::text, 'dbemspg_itb'::name, 'f'::character(1),
    'SELECT backup_data(''pg_counter_min'', ''D:\BACKUP_DB\'',''BACKUP_PG_COUNTER_MIN'');'::text, ''::text
) ;
...
INSERT INTO pgagent.pga_job(
    ...
    1::integer, 'ITB_SOHO_EVERY_5_MIN'::text, ''::text, ''::text, true
) RETURNING jobid INTO jid;
