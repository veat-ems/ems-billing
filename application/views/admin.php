...
<html lang="en">
	...
	<body>
			...
			<div class="sidebar app-aside" id="sidebar">
				<div class="sidebar-container perfect-scrollbar">
					<nav>
						...
						<div class="menuku" id="menuku"  style="background-image:url('assets/general/images/background/<?php echo $background ;?>'); background-size:cover;">
				...
				<header class="navbar navbar-default navbar-static-top">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="" style="font-size:40px;">
							<!--<img src="assets/images/logo.png" alt="IAS-PS"/> --> IAS-PS
						</a>
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-right">
										...
										<div class="drop-down-wrapper ps-container">
											<div class="list-group no-margin">
												<a class="media list-group-item" href="">
													<img class="img-circle" alt="..." src="assets/general/images/avatar-1.jpg">
							...
							<li class="dropdown current-user">
								<a href class="dropdown-toggle" data-toggle="dropdown">
									<img src="assets/general/images/avatar/<?php echo $avatar ;?>" alt="Peter"> <span class="username"><?php echo $username;?> <i class="ti-angle-down"></i></i></span>
								</a>
		...
		<script src="<?php echo base_url(); ?>assets/general/js/index.js"></script>
		<script>
