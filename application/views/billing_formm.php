					...
					<div class="col-12">
						...
						<div class="card card-teal card-outline">
							...
							<div class="card-body">
								...
								echo form_open(base_url() . 'billingm/calculation', $mainformattributes, $hiddenform);
								?>
								<fieldset <div class="row">
									<div class="col-md-3">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" value="<?php echo $kurs ?>" id="kurs" name="kurs">
											<span class="text-warning"><?php echo form_error('kurs'); ?></span>
										</div>
									...
									<div class="col-md-8">
										...
										<script type="text/javascript">
											$('#my-select').multiSelect({
												keepOrder: true,
												selectableHeader: "<div class='custom-header' style='width:600px;'><span class='badge bg-dark' style='font-size:14px;'>Selectable Items ( No | Name | Group )</span></div>",
												selectionHeader: "<div class='custom-header' style='width:300px;'><span class='badge bg-dark' style='font-size:14px;'>Selected Items  ( No | Name | Group )</span></div>"
											});
