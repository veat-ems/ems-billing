					...
					<table class="">
                          ...
                          <tr>
                                ...
                                <td width="45%" class="tdval">
                                    <span id="<?php echo 'val_activeenergy_' . $metergroupid; ?>"><?php echo number_format($metergrouprow->active_energy, 2);?></span>
                                </td>
                                <td width="10%" class="tdsat" >
                                    <span id="<?php echo 'satuan1_' . $metergroupid; ?>">kWh</span>
                                </td>
                          </tr>
                          <tr>
                            	<td class="tdnm" >Maximum Demand</td>
                                <td class="tdval">
                                    <span id="<?php echo 'val_maximumdemand_' . $metergroupid; ?>"><?php echo number_format($metergrouprow->maximum_demand, 2);?></span>
                                </td>
                                <td class="tdsat" >
                                    <span id="<?php echo 'satuan2_' . $metergroupid; ?>">kW</span>
                                </td>
                          </tr>
                          <tr>
                              	<td class="tdnm" >Average Demand</td>
                                  <td class="tdval">
                                    <span id="<?php echo 'val_averagedemand_' . $metergroupid; ?>"><?php echo number_format($metergrouprow->average_demand, 2);?></span>
                                  </td>
                                  <td class="tdsat" >
                                    <span id="<?php echo 'satuan3_' . $metergroupid; ?>">kW</span>
                                  </td>
                          </tr>
                          <tr>
                              	<td class="tdnm" >Apparent Power</td>
                                  <td class="tdval">
                                    <span id="<?php echo 'val_apparentpower_' . $metergroupid; ?>"><?php echo number_format($metergrouprow->apparent_power, 2);?></span>
                                  </td>
                                  <td class="tdsat" >
                                    <span id="<?php echo 'satuan4_' . $metergroupid; ?>">kVA</span>
                                  </td>
                          </tr>
                          <tr>
                                  ...
                                  <td class="tdsat" >
                                    <span id="<?php echo 'satuan5_' . $metergroupid; ?>">kVAR</span>
                                  </td>
                          </tr>		
                          <tr>
                          		<td class="tf small-box-footer" colspan="3">
                                  <span class="small-box-footer" id="<?php echo 'dt_back_' . $metergroupid; ?>">Date-Time</span>                                                              
                          		</td>
                          </tr>
					</table>
