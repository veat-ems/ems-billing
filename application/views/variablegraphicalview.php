					...
					<div class="container" id="container" style="background:#B40000; color:#ffffff; height:55px;">
							<div class="row">
								<form role="form" class="form-horizontal">
									  <div class="col-md-4">
									  	  <div id="namameter" style="font-size:30px; color:#ffffff; font-weight:bold;" align="left"></div>
									 </div>
									 <div class="col-md-8">	
									 	 <div align="right" style="padding-top:5px;">
										 	  <a href="/dashboard" class="btn btn-wide btn-orange btn-squared">
											  	 <i class="ti-dashboard "></i>&nbsp; &nbsp; BACK TO DASHBOARD
											  </a>
										 </div>
									 </div>
								</form>
...
<div id="demourl"></div>
<div id="demourl2" style="width:600px;"></div>
