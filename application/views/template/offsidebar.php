								...
								<div class="users-list">
									<div class="sidebar-content perfect-scrollbar">
										...
										<ul class="media-list">
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													...
													<img alt="..." src="assets/general/images/avatar-2.jpg" class="media-object">
											...
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													...
													<i class="fa fa-circle status-online"></i>
													<img alt="..." src="assets/general/images/avatar-3.jpg" class="media-object">
													<div class="media-body">
											...
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													<i class="fa fa-circle status-online"></i>
													<img alt="..." src="assets/general/images/avatar-4.jpg" class="media-object">
													<div class="media-body">
											...
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													<i class="fa fa-circle status-online"></i>
													<img alt="..." src="assets/general/images/avatar-5.jpg" class="media-object">
													<div class="media-body">
										...
										<ul class="media-list">
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													<img alt="..." src="assets/general/images/avatar-6.jpg" class="media-object">
													<div class="media-body">
														<h4 class="media-heading">Nicole Bell</h4>
														<span> Content Designer </span>
													</div>
											...
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													...
													<img alt="..." src="assets/general/images/avatar-7.jpg" class="media-object">
													<div class="media-body">
														<h4 class="media-heading">Steven Thompson</h4>
														<span> Visual Designer </span>
													</div>
											...
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													<img alt="..." src="assets/general/images/avatar-8.jpg" class="media-object">
													<div class="media-body">
														<h4 class="media-heading">Ella Patterson</h4>
														<span> Web Editor </span>
													</div>
											...
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													<img alt="..." src="assets/general/images/avatar-9.jpg" class="media-object">
													<div class="media-body">
														<h4 class="media-heading">Kenneth Ross</h4>
														<span> Senior Designer </span>
													</div>
											...
											<li class="media">
												<a data-toggle-class="chat-open" data-toggle-target="#users" href="#">
													<img alt="..." src="assets/general/images/avatar-10.jpg" class="media-object">
													<div class="media-body">
														<h4 class="media-heading">Ella Patterson</h4>
														<span> Web Editor </span>
													</div>
											...
											<ol class="discussion">
												...
												<li class="self">
													<div class="message">
														...
														<div class="message-avatar">
															<img src="assets/general/images/avatar-1.jpg" alt="">
														</div>
													</div>
													<div class="message">
														<div class="message-name">
												...
												<li class="other">
													<div class="message">
														...
														<div class="message-avatar">
															<img src="assets/general/images/avatar-2.jpg" alt="">
														</div>
													</div>
												</li>
												<li class="self">
												...
												<li class="self">
													<div class="message">
														...
														<div class="message-text">
															for this type of question, wouldn it be better to try Google?
														</div>
														<div class="message-avatar">
															<img src="assets/general/images/avatar-1.jpg" alt="">
														</div>
