...
<html lang="en">
	...
	<body>
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-right">
							...
							<li class="dropdown current-user">
								<a href class="dropdown-toggle" data-toggle="dropdown">
									<img src="assets/general/images/avatar-1.jpg" alt="Peter"> <span class="username">Peter <i class="ti-angle-down"></i></i></span>
								</a>
		...
		<script src="assets/general/js/index.js"></script>
		<script>
