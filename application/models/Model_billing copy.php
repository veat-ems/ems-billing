...
class Model_billing extends CI_Model{
	...
	function usagereport($var_date_from=false, $var_date_thru=false, $meters=false, $tablename=false ){
		...
		$sql  = "select tdm.id, tdm.id_name, tdm.metergroupid, tdm.id_serial, tdm.area, tdm.lokasi, get_min_date_time_usage(tdm.id, '" . $var_date_from . "', '" . $var_date_thru . "', '" . $tablename . "') as date_time_start, "; 
